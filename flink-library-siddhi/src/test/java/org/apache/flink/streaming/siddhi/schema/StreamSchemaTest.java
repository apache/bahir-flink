...
public class StreamSchemaTest {
    ...
    public void testStreamSchemaWithPojo() {
        ...
        StreamSchema<Event> schema = new StreamSchema<>(typeInfo, new String[] {"id", "timestamp", "name", "price"});
    ...
    public void testStreamSchemaWithTuple() {
        ...
        StreamSchema<Tuple4> schema = new StreamSchema<>(typeInfo, new String[] {"id", "timestamp", "name", "price"});
    ...
    public void testStreamSchemaWithPrimitive() {
        ...
        StreamSchema<String> schema = new StreamSchema<>(typeInfo, new String[] {"words"});
    ...
    public void testStreamSchemaWithPojoAndUnknownField() {
        TypeInformation<Event> typeInfo = TypeExtractor.createTypeInfo(Event.class);
        new StreamSchema<>(typeInfo, new String[] {"id", "timestamp", "name", "price", "unknown"});
    }
