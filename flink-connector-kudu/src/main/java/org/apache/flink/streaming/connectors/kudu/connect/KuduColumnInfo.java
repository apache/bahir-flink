...
public class KuduColumnInfo implements Serializable {
    ...
    protected final boolean hashKey;
    ...
    private KuduColumnInfo(String name, Type type,
                           boolean key, boolean rangeKey, boolean hashKey, boolean nullable,
    ...
    public static class Builder {
        ...
        public KuduColumnInfo build() {
            return new KuduColumnInfo(this.name, this.type, this.key, this.rangeKey, this.hashKey, this.nullable, this.defaultValue, this.blockSize, this.encoding, this.compression);
        }
    }
